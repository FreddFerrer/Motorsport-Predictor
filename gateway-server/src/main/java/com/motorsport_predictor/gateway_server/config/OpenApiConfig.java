...
@OpenAPIDefinition(
        info = @Info(
                ...
                version = "1.0.0",
                description = "**Motorsport Predictor** es una plataforma que permite a los usuarios hacer predicciones sobre los resultados de carreras de Fórmula 1 y otras competiciones de motorsport." +
